...
struct AggregatedDataVariants : private boost::noncopyable
{
    ...
    std::unique_ptr<AggregationMethodABStringNoCache<AggregatedDataWithABStringKey>>               key_string;
    ...
    std::unique_ptr<AggregationMethodABStringNoCache<AggregatedDataWithABStringKeyTwoLevel>>       key_string_two_level;
