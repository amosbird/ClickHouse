...
def test_jbod_ha(start_cluster):
    try:
        ...
        # after 3 seconds jbod1 will be set as broken disk. Let's wait for another 3 seconds for data to be recovered
        time.sleep(5)
        ...
        # mimic disk recovery
        node1.exec_in_container(
            ["bash", "-c", "chmod 755 /jbod1; touch /jbod1/.recover"],
            privileged=True,
            user="root",
        )
        ...
        assert not node1.file_exists("/jbod1/.recover")
