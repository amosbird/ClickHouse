...
MY_CLICKHOUSE_CLIENT="${CLICKHOUSE_CLIENT} --enable_full_text_index 1 --use_skip_indexes 1 --use_skip_indexes_on_data_read 1 --query_plan_text_index_add_hint 1 --use_query_condition_cache 0 --enable_analyzer 1 --query_plan_direct_read_from_text_index 1 --optimize_functions_to_subcolumns 1"
