...
MY_CLICKHOUSE_CLIENT="$CLICKHOUSE_CLIENT --enable_analyzer 1 --enable_full_text_index 1 --use_skip_indexes 1 --use_skip_indexes_on_data_read 1 --query_plan_direct_read_from_text_index 1"
...
$MY_CLICKHOUSE_CLIENT --query "
    ...
    (
        ...
        text1 String,
        text2 String,
        PROJECTION inv_idx1 INDEX text1 TYPE text(tokenizer = 'splitByNonAlpha'),
        PROJECTION inv_idx2 INDEX text2 TYPE text(tokenizer = 'splitByNonAlpha')
    )
    ENGINE = MergeTree
    ORDER BY id
